...
# -*- coding: utf-8 -*-
"""
Created on Thu May 16 22:13:10 2024
...
# Load the dataset
folder = 'D:/datasets/udacity-car-dataset-crowdai/object-detection-crowdai'
...
for ii in range(idx, idx + 50):
    ...
    # cv2.imwrite(os.path.join('/home/Projects/cv/data/tracking/frames', fname),
    ...
    # with open('/home/Projects/cv/data/tracking/sad/boxes.pckl', 'wb') as fid:
